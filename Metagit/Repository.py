"""Repository models and the helpers that discover them in the filesystem.

Holds the git/git-svn repository classes, their status reporting, and the
helpers that discover and describe repositories in the filesystem. The Config
object that loads them from the metagit config file lives in Config.py.
"""
import os
import sys
import subprocess
